...
<div className="popup__conteiner">
  ...
  <form className={`popup__form popup__form_${name}`} name="form-profile" noValidate> 
  {children}
    <button className=" popup__submit-popup-btn" type="submit">{buttonText || 'Сохранить'}</button>
  </form>
</div>
</div>
    )
